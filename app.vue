    ...
    <div class="bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10">
      <div v-if="itemData">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr v-for="item in itemData.list_items" :key="item">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <input type="checkbox" :id="`${item}-checkbox1`" class="form-checkbox h-5 w-5 text-blue-600" />
              </td>

              <td class="px-6 py-4 whitespace-nowrap">
                <input type="checkbox" :id="`${item}-checkbox2`" class="form-checkbox h-5 w-5 text-blue-600" />
              </td>

              <td class="px-6 py-4 whitespace-nowrap">
                <input type="checkbox" :id="`${item}-checkbox3`" class="form-checkbox h-5 w-5 text-blue-600" />
              </td>
        ...
        <div class="mt-4">
          ...
          <textarea id="notes" name="notes" rows="4" class="mt-1 block w-full rounded-md border-black shadow-md focus:border-blue-500 focus:ring-blue-500 sm:text-sm"></textarea>
        </div>
